...
- 🌦️ Weather condition icons (rain, snow, thunderstorm, etc.)
...
- Type-safe data handling with `TWeatherData`
- Weather ID mapping for icons + backgrounds
